...
def main():
    ...
    parser.add_option("-v", "--verbose", action="store_true", dest="verbose", help="print messages to stdout")
    parser.add_option("-q", "--quiet", action="store_false", dest="verbose", help="don't print anything")
    ...
    # clone options
    parser.add_option_group(OptionGroup(parser, "Clones/Pulls a CouchApp from a url (like http://host/db/_design/CA_name)",
            "couchapp clone/pull <url> [dir]"))
